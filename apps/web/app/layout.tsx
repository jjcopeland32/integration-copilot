        ...
        <AuthProvider session={session}>
          <TRPCProvider>
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none">
              <div className="absolute top-[5%] left-[10%] w-96 h-96 bg-indigo-400/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '0s' }} />
              <div className="absolute top-[40%] right-[5%] w-80 h-80 bg-purple-400/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '3s' }} />
              <div className="absolute bottom-[10%] left-[30%] w-72 h-72 bg-blue-400/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '6s' }} />
            </div>
